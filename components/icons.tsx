...
export const XCircle: React.FC<IconProps> = ({ size = 24, ...props }) => (
...
export const ShoppingCart: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
);

export const DollarSign: React.FC<IconProps> = ({ size = 24, ...props }) => (
...
export const List: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line></svg>
);

export const Map: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"></polygon><line x1="8" y1="2" x2="8" y2="18"></line><line x1="16" y1="6" x2="16" y2="22"></line></svg>
);
...
export const Siren: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zM12 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM12 6c-2.21 0-4 1.79-4 4h2c0-1.1.9-2 2-2s2 .9 2 2h2c0-2.21-1.79-4-4-4z"/><path d="M12 18c-3.31 0-6 2.69-6 6h12c0-3.31-2.69-6-6-6z"/></svg>
);
...
export const Minus: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line></svg>
);

export const CreditCard: React.FC<IconProps> = ({ size = 24, ...props }) => (
...
export const Backspace: React.FC<IconProps> = ({ size = 24, ...props }) => (
...
export const Truck: React.FC<IconProps> = ({ size = 24, ...props }) => (
...
export const History: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg>
);
...
export const Tag: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>
);
...
export const BrainCircuit: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4.5 4.5 0 0 0-4.5 4.5c0 2.12.9 3.99 2.25 5.25"></path><path d="M12 2a4.5 4.5 0 0 1 4.5 4.5c0 2.12-.9 3.99-2.25 5.25"></path><path d="M12 11.75c-1.35 1.26-2.25 3.13-2.25 5.25 0 2.49 2.01 4.5 4.5 4.5s4.5-2.01 4.5-4.5c0-2.12-.9-3.99-2.25-5.25"></path><path d="M12 11.75a7.32 7.32 0 0 0-4.005-1.255"></path><path d="M12 11.75a7.32 7.32 0 0 1 4.005-1.255"></path><path d="M2.5 10.5c0-2.49 2.01-4.5 4.5-4.5s4.5 2.01 4.5 4.5"></path><path d="M21.5 10.5c0-2.49-2.01-4.5-4.5-4.5s-4.5 2.01-4.5 4.5"></path><path d="M7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0z"></path><path d="M17 6a2 2 0 1 0 4 0 2 2 0 0 0-4 0z"></path><path d="M12 11.75c-1.35 1.26-2.25 3.13-2.25 5.25"></path><path d="M12 11.75c1.35 1.26 2.25 3.13 2.25 5.25"></path><path d="M7 17a2 2 0 1 0-4 0 2 2 0 0 0 4 0z"></path><path d="M17 17a2 2 0 1 0 4 0 2 2 0 0 0-4 0z"></path></svg>
);